/*
================================================================================
   DASH TRIP PLANNER APP - MASTER MIGRATION SCRIPT (v10.2)
================================================================================

   FILE: migration_file_v10.2_SUPABASE_DASH_TRIP_PLANNER_COMPREHENSIVE.sql
   DATE: 2026-02-23
   
   OVERVIEW:
   This is the DEFINITIVE, COMPREHENSIVE schema definition for the Dash Trip 
   Planner app. It consolidates all previous migrations up to v10.0, and 
   includes the v10.1 patch for avatar URLs in the handle_new_user trigger.
