/*
========================================================================
   DASH TRIP PLANNER APP - MASTER MIGRATION SCRIPT (v7.0)
   ========================================================================
   
   PATH: migration_file_v7.0_SUPABASE_DASH_TRIP_PLANNER_COMPLETE.sql
   
   OVERVIEW:
   This is the DEFINITIVE, COMPLETE schema definition for the Dash Trip Planner app.
   It replaces all previous migration files (v6.8, v6.12, etc.).
   
   KEY CHANGES (v7.0):
   - Merged v6.8 (Voting constraints, RLS fixes).
   - Merged v6.12 (Global Settings: theme_preference, language_preference).
   - Full 'DROP AND RECREATE' strategy for clean deployment.
