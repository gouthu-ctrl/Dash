/*
========================================================================
   DASH TRIP PLANNER APP - MASTER MIGRATION SCRIPT (v6.6)
========================================================================
   
   PATH: d:\StudioProjects\Dash\migration_file_v6.6_supabase_dash_trip_planner_complete.sql
   
   OVERVIEW:
   This is the DEFINITIVE, COMPLETE schema definition for the Dash Trip Planner app.
   It replaces all previous migration files (including v6.5).
   
   KEY CHANGES (v6.6):
   - Confirmed strict RLS for Editors (Insert/Update/Delete).
   - Confirmed strict RLS for Viewers (Select Only).
   - Confirmed Voting Persistence (Separate Policies).
   - Confirmed Trip Member Linking Logic.
   
   IMPORTANT:
   The "Editor Cannot Edit" bug was primarily a client-side issue (comparing 
   Member ID vs User ID), but this schema ensures the backend permissions 
   are absolutely correct and secure.
