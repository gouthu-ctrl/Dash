/*
========================================================================
   DASH TRIP PLANNER APP - MASTER MIGRATION SCRIPT (v6.7)
========================================================================
   
   PATH: d:\StudioProjects\Dash\migration_file_v6.7_supabase_dash_trip_planner_complete.sql
   
   OVERVIEW:
   This is the DEFINITIVE, COMPLETE schema definition for the Dash Trip Planner app.
   It replaces all previous migration files (including v6.6).
   
   KEY CHANGES (v6.7):
   - ADDED `cast_vote` RPC function to handle voting securely and reliably serverside.
   - Ensures voting persistence using atomic UPSERT logic.
   - Retains all previous RLS fixes for Editors (v6.6).
...
-- [VOTING RPC FUNCTION - v6.7 Addition]
